...
export const Settings = () => {
  ...
  const handleSubmitPassword = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://nextgen-backend-zx9m.onrender.com/api/users/change-password",
        {
          method: "POST",
          headers: {
  ...
  const handleBuyCredits = async () => {
    try {
      const response = await fetch(
        "https://nextgen-backend-zx9m.onrender.com/api/users/purchase-credits",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleBuySubscription = async () => {
    try {
      const response = await fetch(
        "https://nextgen-backend-zx9m.onrender.com/api/users/purchase-subscription",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
